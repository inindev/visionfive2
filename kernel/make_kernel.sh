...
main() {
    local linux='https://cdn.kernel.org/pub/linux/kernel/v6.x/linux-6.11.3.tar.xz'
    local lxsha='057263d0afc17d5253794afd3d239ba4da4aa734b22fa36c1665f41b95449b73'
